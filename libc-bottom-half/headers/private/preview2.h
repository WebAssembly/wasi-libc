...
typedef struct {
  imports_string_t f0;
  imports_string_t f1;
} environment_tuple2_string_string_t;

typedef struct {
  environment_tuple2_string_string_t *ptr;
  size_t len;
} environment_list_tuple2_string_string_t;

typedef struct {
  imports_string_t *ptr;
  size_t len;
} environment_list_string_t;

typedef struct {
  bool is_some;
  imports_string_t val;
} environment_option_string_t;
...
typedef struct {
  uint8_t *ptr;
  size_t len;
} filesystem_list_u8_t;

typedef struct {
  filesystem_list_u8_t f0;
  bool f1;
} filesystem_tuple2_list_u8_bool_t;

typedef struct {
  bool is_err;
  union {
    filesystem_tuple2_list_u8_bool_t ok;
    filesystem_error_code_t err;
  } val;
...
extern void environment_get_environment(environment_list_tuple2_string_string_t *ret);
// Get the POSIX-style arguments to the program.
extern void environment_get_arguments(environment_list_string_t *ret);
...
// hazard.
extern void io_error_method_error_to_debug_string(io_error_borrow_error_t self, imports_string_t *ret);
...
extern void poll_poll(poll_list_borrow_pollable_t *in, poll_list_u32_t *ret);
...
extern bool streams_method_input_stream_read(streams_borrow_input_stream_t self, uint64_t len, streams_list_u8_t *ret, streams_stream_error_t *err);
// Read bytes from a stream, after blocking until at least one byte can
// be read. Except for blocking, behavior is identical to `read`.
extern bool streams_method_input_stream_blocking_read(streams_borrow_input_stream_t self, uint64_t len, streams_list_u8_t *ret, streams_stream_error_t *err);
...
extern bool streams_method_output_stream_write(streams_borrow_output_stream_t self, streams_list_u8_t *contents, streams_stream_error_t *err);
...
// while !contents.is_empty() {
  ...
  // ```
  extern bool streams_method_output_stream_blocking_write_and_flush(streams_borrow_output_stream_t self, streams_list_u8_t *contents, streams_stream_error_t *err);
  ...
  // while num_zeroes != 0 {
    ...
    extern bool filesystem_method_descriptor_read(filesystem_borrow_descriptor_t self, filesystem_filesize_t length, filesystem_filesize_t offset, filesystem_tuple2_list_u8_bool_t *ret, filesystem_error_code_t *err);
    ...
    extern bool filesystem_method_descriptor_write(filesystem_borrow_descriptor_t self, filesystem_list_u8_t *buffer, filesystem_filesize_t offset, filesystem_filesize_t *ret, filesystem_error_code_t *err);
    ...
    extern bool filesystem_method_descriptor_create_directory_at(filesystem_borrow_descriptor_t self, imports_string_t *path, filesystem_error_code_t *err);
    ...
    extern bool filesystem_method_descriptor_stat_at(filesystem_borrow_descriptor_t self, filesystem_path_flags_t path_flags, imports_string_t *path, filesystem_descriptor_stat_t *ret, filesystem_error_code_t *err);
    ...
    // WASI.
    extern bool filesystem_method_descriptor_set_times_at(filesystem_borrow_descriptor_t self, filesystem_path_flags_t path_flags, imports_string_t *path, filesystem_new_timestamp_t *data_access_timestamp, filesystem_new_timestamp_t *data_modification_timestamp, filesystem_error_code_t *err);
    // Create a hard link.
    // 
    // Note: This is similar to `linkat` in POSIX.
    extern bool filesystem_method_descriptor_link_at(filesystem_borrow_descriptor_t self, filesystem_path_flags_t old_path_flags, imports_string_t *old_path, filesystem_borrow_descriptor_t new_descriptor, imports_string_t *new_path, filesystem_error_code_t *err);
    ...
    extern bool filesystem_method_descriptor_open_at(filesystem_borrow_descriptor_t self, filesystem_path_flags_t path_flags, imports_string_t *path, filesystem_open_flags_t open_flags, filesystem_descriptor_flags_t flags, filesystem_own_descriptor_t *ret, filesystem_error_code_t *err);
    ...
    extern bool filesystem_method_descriptor_readlink_at(filesystem_borrow_descriptor_t self, imports_string_t *path, imports_string_t *ret, filesystem_error_code_t *err);
    // Remove a directory.
    // 
    // Return `error-code::not-empty` if the directory is not empty.
    // 
    // Note: This is similar to `unlinkat(fd, path, AT_REMOVEDIR)` in POSIX.
    extern bool filesystem_method_descriptor_remove_directory_at(filesystem_borrow_descriptor_t self, imports_string_t *path, filesystem_error_code_t *err);
    // Rename a filesystem object.
    // 
    // Note: This is similar to `renameat` in POSIX.
    extern bool filesystem_method_descriptor_rename_at(filesystem_borrow_descriptor_t self, imports_string_t *old_path, filesystem_borrow_descriptor_t new_descriptor, imports_string_t *new_path, filesystem_error_code_t *err);
    ...
    extern bool filesystem_method_descriptor_symlink_at(filesystem_borrow_descriptor_t self, imports_string_t *old_path, imports_string_t *new_path, filesystem_error_code_t *err);
    // Unlink a filesystem object that is not a directory.
    // 
    // Return `error-code::is-directory` if the path refers to a directory.
    // Note: This is similar to `unlinkat(fd, path, 0)` in POSIX.
    extern bool filesystem_method_descriptor_unlink_file_at(filesystem_borrow_descriptor_t self, imports_string_t *path, filesystem_error_code_t *err);
    ...
    extern bool filesystem_method_descriptor_metadata_hash_at(filesystem_borrow_descriptor_t self, filesystem_path_flags_t path_flags, imports_string_t *path, filesystem_metadata_hash_value_t *ret, filesystem_error_code_t *err);
    ...
    // if (was previously connected) {
      ...
      // if (remote_address is Some) {
        ...
        extern bool ip_name_lookup_resolve_addresses(ip_name_lookup_borrow_network_t network, imports_string_t *name, ip_name_lookup_own_resolve_address_stream_t *ret, ip_name_lookup_error_code_t *err);
        ...
        // data.
        extern void random_get_random_bytes(uint64_t len, random_list_u8_t *ret);
        ...
        // a long period.
        extern void random_insecure_get_insecure_random_bytes(uint64_t len, random_list_u8_t *ret);
        ...
        // protection.
        extern void random_insecure_seed_insecure_seed(random_insecure_seed_tuple2_u64_u64_t *ret);
        ...
        extern void io_error_error_drop_borrow(io_error_own_error_t handle);
        ...
        extern void poll_pollable_drop_borrow(poll_own_pollable_t handle);
        ...
        extern void streams_input_stream_drop_borrow(streams_own_input_stream_t handle);
        ...
        extern void streams_output_stream_drop_borrow(streams_own_output_stream_t handle);
        ...
        extern void filesystem_descriptor_drop_borrow(filesystem_own_descriptor_t handle);
        ...
        extern void filesystem_directory_entry_stream_drop_borrow(filesystem_own_directory_entry_stream_t handle);
        ...
        extern void network_network_drop_borrow(network_own_network_t handle);
        ...
        extern void udp_udp_socket_drop_borrow(udp_own_udp_socket_t handle);
        ...
        extern void udp_incoming_datagram_stream_drop_borrow(udp_own_incoming_datagram_stream_t handle);
        ...
        extern void udp_outgoing_datagram_stream_drop_borrow(udp_own_outgoing_datagram_stream_t handle);
        ...
        extern void tcp_tcp_socket_drop_borrow(tcp_own_tcp_socket_t handle);
        ...
        extern void ip_name_lookup_resolve_address_stream_drop_borrow(ip_name_lookup_own_resolve_address_stream_t handle);
