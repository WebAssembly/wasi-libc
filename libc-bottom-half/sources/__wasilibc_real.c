...
int32_t __imported_wasix_64v1_thread_spawn(int64_t arg0, int64_t arg1) __attribute__((
    __import_module__("wasix_64v1"),
...
__wasi_errno_t __wasi_thread_spawn(
    ...
    int32_t ret = __imported_wasix_64v1_thread_spawn((int64_t) args, (intptr_t) retptr0);
    return (uint16_t) ret;
}
