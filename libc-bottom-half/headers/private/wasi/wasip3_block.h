...
void wasip3_subtask_block_on_and_drop(wasip3_subtask_t status);
...
void wasip3_future_block_on(wasip3_subtask_status_t status, uint32_t future);
...
size_t wasip3_stream_block_on(wasip3_subtask_status_t status, uint32_t stream, bool *closed);
#endif
