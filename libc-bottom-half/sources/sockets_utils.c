...
#define SOCKETS_ERROR_CODE_ADDRESS_NOT_BINDABLE NETWORK_ERROR_CODE_ADDRESS_NOT_BINDABLE
#define SOCKETS_ERROR_CODE_ADDRESS_IN_USE NETWORK_ERROR_CODE_ADDRESS_IN_USE
#define SOCKETS_ERROR_CODE_REMOTE_UNREACHABLE NETWORK_ERROR_CODE_REMOTE_UNREACHABLE
#define SOCKETS_ERROR_CODE_CONNECTION_REFUSED NETWORK_ERROR_CODE_CONNECTION_REFUSED
#define SOCKETS_ERROR_CODE_CONNECTION_RESET NETWORK_ERROR_CODE_CONNECTION_RESET
#define SOCKETS_ERROR_CODE_CONNECTION_ABORTED NETWORK_ERROR_CODE_CONNECTION_ABORTED
#define SOCKETS_ERROR_CODE_DATAGRAM_TOO_LARGE NETWORK_ERROR_CODE_DATAGRAM_TOO_LARGE
