...
#ifdef __wasm_libcall_thread_context__ // wasi-threads has no semaphores
...
long sysconf(int name)
{
	...
	case JT_PAGE_SIZE & 255:
		return PAGE_SIZE;
#if defined(__wasilibc_unmodified_upstream) || defined(__wasm_libcall_thread_context__) // wasi-threads has no semaphores
