...
// Resource unavailable, or operation would block, similar to `EAGAIN` and
// `EWOULDBLOCK` in POSIX.
...
typedef struct udp_incoming_datagram_t {
  ...
  // The source address.
  //
  // This field is guaranteed to match the remote address the stream was
  // initialized with, if any.
  //
...
typedef struct udp_outgoing_datagram_t {
  ...
  // - with a remote address: this field must be None or match the stream's
  // remote address exactly.
  // - without a remote address: this field is required.
  //
  // If this value is None, the send operation is equivalent to `send` in POSIX.
  // Otherwise it is equivalent to `sendto`.
...
extern void
environment_get_environment(wasip2_list_tuple2_string_string_t *ret);
...
// hazard.
extern void io_error_method_error_to_debug_string(io_error_borrow_error_t self,
                                                  wasip2_string_t *ret);
...
extern bool streams_method_input_stream_read(streams_borrow_input_stream_t self,
                                             uint64_t len,
...
extern bool
streams_method_input_stream_blocking_read(streams_borrow_input_stream_t self,
...
extern bool streams_method_input_stream_skip(streams_borrow_input_stream_t self,
                                             uint64_t len, uint64_t *ret,
                                             streams_stream_error_t *err);
// Skip bytes from a stream, after blocking until at least one byte
// can be skipped. Except for blocking behavior, identical to `skip`.
extern bool
streams_method_input_stream_blocking_skip(streams_borrow_input_stream_t self,
                                          uint64_t len, uint64_t *ret,
                                          streams_stream_error_t *err);
...
// error.
extern bool
streams_method_output_stream_check_write(streams_borrow_output_stream_t self,
                                         uint64_t *ret,
                                         streams_stream_error_t *err);
...
extern bool
streams_method_output_stream_write(streams_borrow_output_stream_t self,
...
// ```
extern bool streams_method_output_stream_blocking_write_and_flush(
...
extern bool
streams_method_output_stream_flush(streams_borrow_output_stream_t self,
                                   streams_stream_error_t *err);
// Request to flush buffered output, and block until flush completes
// and stream is ready for writing again.
extern bool
streams_method_output_stream_blocking_flush(streams_borrow_output_stream_t self,
                                            streams_stream_error_t *err);
...
extern bool
streams_method_output_stream_write_zeroes(streams_borrow_output_stream_t self,
                                          uint64_t len,
                                          streams_stream_error_t *err);
...
// let _ = this.check-write();         // eliding error handling
// ```
extern bool streams_method_output_stream_blocking_write_zeroes_and_flush(
...
// than `len`.
extern bool streams_method_output_stream_splice(
...
extern bool streams_method_output_stream_blocking_splice(
    streams_borrow_output_stream_t self, streams_borrow_input_stream_t src,
    uint64_t len, uint64_t *ret, streams_stream_error_t *err);
...
// occured.
extern monotonic_clock_own_pollable_t
...
extern bool filesystem_method_descriptor_read_via_stream(
...
// POSIX.
extern bool filesystem_method_descriptor_write_via_stream(
    filesystem_borrow_descriptor_t self, filesystem_filesize_t offset,
...
extern bool filesystem_method_descriptor_append_via_stream(
    filesystem_borrow_descriptor_t self, filesystem_own_output_stream_t *ret,
    filesystem_error_code_t *err);
// Provide file advisory information on a descriptor.
//
// This is similar to `posix_fadvise` in POSIX.
extern bool filesystem_method_descriptor_advise(
    filesystem_borrow_descriptor_t self, filesystem_filesize_t offset,
...
extern bool
filesystem_method_descriptor_sync_data(filesystem_borrow_descriptor_t self,
                                       filesystem_error_code_t *err);
...
extern bool
filesystem_method_descriptor_get_flags(filesystem_borrow_descriptor_t self,
...
// from `fdstat_get` in earlier versions of WASI.
extern bool
filesystem_method_descriptor_get_type(filesystem_borrow_descriptor_t self,
...
extern bool
filesystem_method_descriptor_set_size(filesystem_borrow_descriptor_t self,
                                      filesystem_filesize_t size,
                                      filesystem_error_code_t *err);
...
extern bool filesystem_method_descriptor_set_times(
...
extern bool filesystem_method_descriptor_read(
    filesystem_borrow_descriptor_t self, filesystem_filesize_t length,
    filesystem_filesize_t offset, wasip2_tuple2_list_u8_bool_t *ret,
    filesystem_error_code_t *err);
...
extern bool filesystem_method_descriptor_write(
    filesystem_borrow_descriptor_t self, wasip2_list_u8_t *buffer,
    filesystem_filesize_t offset, filesystem_filesize_t *ret,
    filesystem_error_code_t *err);
...
extern bool filesystem_method_descriptor_read_directory(
    filesystem_borrow_descriptor_t self,
    filesystem_own_directory_entry_stream_t *ret, filesystem_error_code_t *err);
...
extern bool filesystem_method_descriptor_create_directory_at(
...
extern bool
filesystem_method_descriptor_stat(filesystem_borrow_descriptor_t self,
...
extern bool filesystem_method_descriptor_stat_at(
    filesystem_borrow_descriptor_t self, filesystem_path_flags_t path_flags,
    wasip2_string_t *path, filesystem_descriptor_stat_t *ret,
    filesystem_error_code_t *err);
...
// WASI.
extern bool filesystem_method_descriptor_set_times_at(
    filesystem_borrow_descriptor_t self, filesystem_path_flags_t path_flags,
...
extern bool filesystem_method_descriptor_link_at(
...
extern bool filesystem_method_descriptor_open_at(
    filesystem_borrow_descriptor_t self, filesystem_path_flags_t path_flags,
    wasip2_string_t *path, filesystem_open_flags_t open_flags,
    filesystem_descriptor_flags_t flags, filesystem_own_descriptor_t *ret,
    filesystem_error_code_t *err);
...
extern bool filesystem_method_descriptor_readlink_at(
    filesystem_borrow_descriptor_t self, wasip2_string_t *path,
...
extern bool filesystem_method_descriptor_remove_directory_at(
    filesystem_borrow_descriptor_t self, wasip2_string_t *path,
    filesystem_error_code_t *err);
// Rename a filesystem object.
//
// Note: This is similar to `renameat` in POSIX.
extern bool filesystem_method_descriptor_rename_at(
...
extern bool filesystem_method_descriptor_symlink_at(
    filesystem_borrow_descriptor_t self, wasip2_string_t *old_path,
    wasip2_string_t *new_path, filesystem_error_code_t *err);
...
extern bool
filesystem_method_descriptor_unlink_file_at(filesystem_borrow_descriptor_t self,
...
// may be used instead.
extern bool filesystem_method_descriptor_is_same_object(
...
extern bool filesystem_method_descriptor_metadata_hash(
...
extern bool filesystem_method_descriptor_metadata_hash_at(
    filesystem_borrow_descriptor_t self, filesystem_path_flags_t path_flags,
    wasip2_string_t *path, filesystem_metadata_hash_value_t *ret,
    filesystem_error_code_t *err);
// Read a single directory entry from a `directory-entry-stream`.
extern bool filesystem_method_directory_entry_stream_read_directory_entry(
...
extern bool filesystem_filesystem_error_code(filesystem_borrow_error_t err_,
...
// - `address-not-bindable`:      `local-address` is not an address that the
// `network` can bind to. (EADDRNOTAVAIL)
// - `not-in-progress`:           A `bind` operation is not in progress.
// - `would-block`:               Can't finish the operation, it is still in
// progress. (EWOULDBLOCK, EAGAIN)
//
// # Implementors note
...
extern bool udp_method_udp_socket_start_bind(
    udp_borrow_udp_socket_t self, udp_borrow_network_t network,
    udp_ip_socket_address_t *local_address, udp_error_code_t *err);
extern bool udp_method_udp_socket_finish_bind(udp_borrow_udp_socket_t self,
                                              udp_error_code_t *err);
// Set up inbound & outbound communication channels, optionally to a specific
// peer.
//
// This function only changes the local socket configuration and does not
// generate any network traffic. On success, the `remote-address` of the socket
// is updated. The `local-address` may be updated as well, based on the best
// network path to `remote-address`.
//
// When a `remote-address` is provided, the returned streams are limited to
// communicating with that specific peer:
// - `send` can only be used to send to this destination.
// - `receive` will only return datagrams sent from the provided
// `remote-address`.
//
// This method may be called multiple times on the same socket to change its
// association, but only the most recently returned pair of streams will be
// operational. Implementations may trap if the streams returned by a previous
...
// (ECONNRESET, ENETRESET, EHOSTUNREACH, EHOSTDOWN, ENETUNREACH, ENETDOWN,
// ENONET)
...
extern bool udp_method_udp_socket_stream(
...
//
// WASI is stricter and requires `local-address` to return `invalid-state` when
// the socket hasn't been bound yet.
//
// # Typical errors
...
extern bool udp_method_udp_socket_local_address(udp_borrow_udp_socket_t self,
                                                udp_ip_socket_address_t *ret,
                                                udp_error_code_t *err);
// Get the address the socket is currently streaming to.
//
// # Typical errors
// - `invalid-state`: The socket is not streaming to a specific remote address.
// (ENOTCONN)
//
// # References
// -
...
extern bool udp_method_udp_socket_remote_address(udp_borrow_udp_socket_t self,
                                                 udp_ip_socket_address_t *ret,
                                                 udp_error_code_t *err);
// Whether this is a IPv4 or IPv6 socket.
//
// Equivalent to the SO_DOMAIN socket option.
extern udp_ip_address_family_t
...
extern bool
udp_method_udp_socket_unicast_hop_limit(udp_borrow_udp_socket_t self,
                                        uint8_t *ret, udp_error_code_t *err);
extern bool udp_method_udp_socket_set_unicast_hop_limit(
    udp_borrow_udp_socket_t self, uint8_t value, udp_error_code_t *err);
...
extern bool
udp_method_udp_socket_receive_buffer_size(udp_borrow_udp_socket_t self,
                                          uint64_t *ret, udp_error_code_t *err);
extern bool udp_method_udp_socket_set_receive_buffer_size(
    udp_borrow_udp_socket_t self, uint64_t value, udp_error_code_t *err);
extern bool udp_method_udp_socket_send_buffer_size(udp_borrow_udp_socket_t self,
                                                   uint64_t *ret,
                                                   udp_error_code_t *err);
extern bool udp_method_udp_socket_set_send_buffer_size(
    udp_borrow_udp_socket_t self, uint64_t value, udp_error_code_t *err);
// Create a `pollable` which will resolve once the socket is ready for I/O.
//
// Note: this function is here for WASI Preview2 only.
// It's planned to be removed when `future` is natively supported in Preview3.
extern udp_own_pollable_t
...
// without blocking. The returned list may contain fewer elements than
...
extern bool udp_method_incoming_datagram_stream_receive(
    udp_borrow_incoming_datagram_stream_t self, uint64_t max_results,
    udp_list_incoming_datagram_t *ret, udp_error_code_t *err);
// Create a `pollable` which will resolve once the stream is ready to receive
// again.
//
// Note: this function is here for WASI Preview2 only.
// It's planned to be removed when `future` is natively supported in Preview3.
extern udp_own_pollable_t udp_method_incoming_datagram_stream_subscribe(
...
extern bool udp_method_outgoing_datagram_stream_check_send(
...
// blocking and returns how many messages were actually sent (or queued for
// sending). This function never returns `error(would-block)`. If none of the
// datagrams were able to be sent, `ok(0)` is returned.
//
// This function semantically behaves the same as iterating the `datagrams` list
// and sequentially sending each individual datagram until either the end of the
// list has been reached or the first error occurred. If at least one datagram
// has been sent successfully, this function never returns an error.
//
...
extern bool udp_method_outgoing_datagram_stream_send(
    udp_borrow_outgoing_datagram_stream_t self,
    udp_list_outgoing_datagram_t *datagrams, uint64_t *ret,
    udp_error_code_t *err);
// Create a `pollable` which will resolve once the stream is ready to send
// again.
//
// Note: this function is here for WASI Preview2 only.
// It's planned to be removed when `future` is natively supported in Preview3.
extern udp_own_pollable_t udp_method_outgoing_datagram_stream_subscribe(
    udp_borrow_outgoing_datagram_stream_t self);
...
// otherwise.
//
// This function does not require a network capability handle. This is
// considered to be safe because at time of creation, the socket is not bound to
// any `network` yet. Up to the moment `bind` is called, the socket is
// effectively an in-memory configuration object, unable to communicate with the
// outside world.
//
// All sockets are non-blocking. Use the wasi-poll interface to block on
// asynchronous operations.
//
// # Typical errors
// - `not-supported`:     The specified `address-family` is not supported.
// (EAFNOSUPPORT)
// - `new-socket-limit`:  The new socket resource could not be created because
// of a system limit. (EMFILE, ENFILE)
//
// # References:
...
extern bool udp_create_socket_create_udp_socket(
...
// <https://learn.microsoft.com/en-us/windows/win32/api/winsock/nf-winsock-bind>
// - <https://man.freebsd.org/cgi/man.cgi?query=bind&sektion=2&format=html>
extern bool tcp_method_tcp_socket_start_bind(
    tcp_borrow_tcp_socket_t self, tcp_borrow_network_t network,
    tcp_ip_socket_address_t *local_address, tcp_error_code_t *err);
extern bool tcp_method_tcp_socket_finish_bind(tcp_borrow_tcp_socket_t self,
                                              tcp_error_code_t *err);
// Connect to a remote endpoint.
//
// On success:
// - the socket is transitioned into the `connection` state.
// - a pair of streams is returned that can be used to read & write to the
// connection
//
...
// - `invalid-argument`:          The socket is already attached to a different
// network. The `network` passed to `connect` must be identical to the one
// passed to `bind`.
...
// <https://learn.microsoft.com/en-us/windows/win32/api/winsock2/nf-winsock2-connect>
// - <https://man.freebsd.org/cgi/man.cgi?connect>
extern bool tcp_method_tcp_socket_start_connect(
    tcp_borrow_tcp_socket_t self, tcp_borrow_network_t network,
    tcp_ip_socket_address_t *remote_address, tcp_error_code_t *err);
extern bool tcp_method_tcp_socket_finish_connect(
...
extern bool tcp_method_tcp_socket_start_listen(tcp_borrow_tcp_socket_t self,
                                               tcp_error_code_t *err);
extern bool tcp_method_tcp_socket_finish_listen(tcp_borrow_tcp_socket_t self,
                                                tcp_error_code_t *err);
// Accept a new client socket.
//
// The returned socket is bound and in the `connected` state. The following
// properties are inherited from the listener socket:
// - `address-family`
// - `keep-alive-enabled`
...
// - `would-block`:        No pending connections at the moment. (EWOULDBLOCK,
// EAGAIN)
// - `connection-aborted`: An incoming connection was pending, but was
// terminated by the client before this listener could accept it. (ECONNABORTED)
// - `new-socket-limit`:   The new socket resource could not be created because
// of a system limit. (EMFILE, ENFILE)
//
// # References
...
extern bool tcp_method_tcp_socket_accept(
    tcp_borrow_tcp_socket_t self,
...
// <https://learn.microsoft.com/en-us/windows/win32/api/winsock/nf-winsock-getsockname>
// - <https://man.freebsd.org/cgi/man.cgi?getsockname>
extern bool tcp_method_tcp_socket_local_address(tcp_borrow_tcp_socket_t self,
...
// <https://learn.microsoft.com/en-us/windows/win32/api/winsock/nf-winsock-getpeername>
// - <https://man.freebsd.org/cgi/man.cgi?query=getpeername&sektion=2&n=1>
extern bool tcp_method_tcp_socket_remote_address(tcp_borrow_tcp_socket_t self,
                                                 tcp_ip_socket_address_t *ret,
                                                 tcp_error_code_t *err);
...
//
// Equivalent to the SO_DOMAIN socket option.
extern tcp_ip_address_family_t
...
// `connected` state.
extern bool tcp_method_tcp_socket_set_listen_backlog_size(
    tcp_borrow_tcp_socket_t self, uint64_t value, tcp_error_code_t *err);
...
extern bool
tcp_method_tcp_socket_keep_alive_enabled(tcp_borrow_tcp_socket_t self,
                                         bool *ret, tcp_error_code_t *err);
extern bool
tcp_method_tcp_socket_set_keep_alive_enabled(tcp_borrow_tcp_socket_t self,
                                             bool value, tcp_error_code_t *err);
...
// # Typical errors
// - `invalid-argument`:     (set) The provided value was 0.
extern bool tcp_method_tcp_socket_keep_alive_idle_time(
    tcp_borrow_tcp_socket_t self, tcp_duration_t *ret, tcp_error_code_t *err);
extern bool tcp_method_tcp_socket_set_keep_alive_idle_time(
...
// # Typical errors
// - `invalid-argument`:     (set) The provided value was 0.
extern bool tcp_method_tcp_socket_keep_alive_interval(
    tcp_borrow_tcp_socket_t self, tcp_duration_t *ret, tcp_error_code_t *err);
extern bool tcp_method_tcp_socket_set_keep_alive_interval(
    tcp_borrow_tcp_socket_t self, tcp_duration_t value, tcp_error_code_t *err);
...
// # Typical errors
// - `invalid-argument`:     (set) The provided value was 0.
extern bool tcp_method_tcp_socket_keep_alive_count(tcp_borrow_tcp_socket_t self,
                                                   uint32_t *ret,
                                                   tcp_error_code_t *err);
extern bool tcp_method_tcp_socket_set_keep_alive_count(
    tcp_borrow_tcp_socket_t self, uint32_t value, tcp_error_code_t *err);
// Equivalent to the IP_TTL & IPV6_UNICAST_HOPS socket options.
//
// If the provided value is 0, an `invalid-argument` error is returned.
//
// # Typical errors
// - `invalid-argument`:     (set) The TTL value must be 1 or higher.
extern bool tcp_method_tcp_socket_hop_limit(tcp_borrow_tcp_socket_t self,
                                            uint8_t *ret,
                                            tcp_error_code_t *err);
extern bool tcp_method_tcp_socket_set_hop_limit(tcp_borrow_tcp_socket_t self,
                                                uint8_t value,
                                                tcp_error_code_t *err);
// The kernel buffer space reserved for sends/receives on this socket.
//
...
// - `invalid-argument`:     (set) The provided value was 0.
extern bool
tcp_method_tcp_socket_receive_buffer_size(tcp_borrow_tcp_socket_t self,
                                          uint64_t *ret, tcp_error_code_t *err);
extern bool tcp_method_tcp_socket_set_receive_buffer_size(
    tcp_borrow_tcp_socket_t self, uint64_t value, tcp_error_code_t *err);
extern bool tcp_method_tcp_socket_send_buffer_size(tcp_borrow_tcp_socket_t self,
                                                   uint64_t *ret,
                                                   tcp_error_code_t *err);
extern bool tcp_method_tcp_socket_set_send_buffer_size(
    tcp_borrow_tcp_socket_t self, uint64_t value, tcp_error_code_t *err);
...
// - `send`: The socket has no more data to send to the peer. The
// `output-stream`
...
extern bool tcp_method_tcp_socket_shutdown(tcp_borrow_tcp_socket_t self,
...
// This function does not require a network capability handle. This is
// considered to be safe because at time of creation, the socket is not bound to
// any `network` yet. Up to the moment `bind`/`connect` is called, the socket is
// effectively an in-memory configuration object, unable to communicate with the
// outside world.
//
// All sockets are non-blocking. Use the wasi-poll interface to block on
...
// <https://learn.microsoft.com/en-us/windows/win32/api/winsock2/nf-winsock2-wsasocketw>
// - <https://man.freebsd.org/cgi/man.cgi?query=socket&sektion=2>
extern bool tcp_create_socket_create_tcp_socket(
...
//
// # Typical errors
// - `invalid-argument`: `name` is a syntactically invalid domain name or IP
// address.
//
// # References:
// -
...
extern bool ip_name_lookup_resolve_addresses(
...
//
// # Typical errors
// - `name-unresolvable`:          Name does not exist or has no suitable
// associated IP addresses. (EAI_NONAME, EAI_NODATA, EAI_ADDRFAMILY)
...
// occurred. (EAI_FAIL)
// - `would-block`:                A result is not available yet. (EWOULDBLOCK,
// EAGAIN)
extern bool ip_name_lookup_method_resolve_address_stream_resolve_next_address(
...
// Note: this function is here for WASI Preview2 only.
// It's planned to be removed when `future` is natively supported in Preview3.
extern ip_name_lookup_own_pollable_t
...
extern io_error_borrow_error_t
io_error_borrow_error(io_error_own_error_t handle);
...
extern streams_borrow_input_stream_t
streams_borrow_input_stream(streams_own_input_stream_t handle);

extern void streams_output_stream_drop_own(streams_own_output_stream_t handle);

extern streams_borrow_output_stream_t
streams_borrow_output_stream(streams_own_output_stream_t handle);
...
extern void filesystem_directory_entry_stream_drop_own(
    filesystem_own_directory_entry_stream_t handle);

extern filesystem_borrow_directory_entry_stream_t
...
extern network_borrow_network_t
network_borrow_network(network_own_network_t handle);
...
extern udp_borrow_udp_socket_t
udp_borrow_udp_socket(udp_own_udp_socket_t handle);

extern void udp_incoming_datagram_stream_drop_own(
    udp_own_incoming_datagram_stream_t handle);

extern udp_borrow_incoming_datagram_stream_t
udp_borrow_incoming_datagram_stream(udp_own_incoming_datagram_stream_t handle);

extern void udp_outgoing_datagram_stream_drop_own(
    udp_own_outgoing_datagram_stream_t handle);

extern udp_borrow_outgoing_datagram_stream_t
udp_borrow_outgoing_datagram_stream(udp_own_outgoing_datagram_stream_t handle);
...
extern tcp_borrow_tcp_socket_t
tcp_borrow_tcp_socket(tcp_own_tcp_socket_t handle);
...
extern void ip_name_lookup_resolve_address_stream_drop_own(
    ip_name_lookup_own_resolve_address_stream_t handle);

extern ip_name_lookup_borrow_resolve_address_stream_t
