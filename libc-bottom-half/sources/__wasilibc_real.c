...
int32_t __imported_wasix_64v1_bus_spawn_local(int64_t arg0, int64_t arg1, int32_t arg2, int64_t arg3, int64_t arg4, int64_t arg5, int64_t arg6, int32_t arg7, int32_t arg8, int32_t arg9, int64_t arg10, int64_t arg11, int64_t arg12) __attribute__((
    __import_module__("wasix_64v1"),
...
__wasi_bus_error_t __wasi_bus_spawn_local(
    ...
    int32_t ret = __imported_wasix_64v1_bus_spawn_local((intptr_t) name, (intptr_t) name_len, (int32_t) chroot, (intptr_t) args, (intptr_t) args_len, (intptr_t) preopen, (intptr_t) preopen_len, (int32_t) stdin, (int32_t) stdout, (int32_t) stderr, (intptr_t) working_dir, (intptr_t) working_dir_len, (intptr_t) retptr0);
    return (uint32_t) ret;
}

int32_t __imported_wasix_64v1_bus_spawn_remote(int64_t arg0, int64_t arg1, int32_t arg2, int64_t arg3, int64_t arg4, int64_t arg5, int64_t arg6, int64_t arg7, int64_t arg8, int32_t arg9, int32_t arg10, int32_t arg11, int64_t arg12, int64_t arg13, int64_t arg14, int64_t arg15, int64_t arg16) __attribute__((
    __import_module__("wasix_64v1"),
...
int32_t __imported_wasix_64v1_bus_invoke(int32_t arg0, int64_t arg1, int32_t arg2, int64_t arg3, int64_t arg4, int32_t arg5, int64_t arg6, int64_t arg7, int64_t arg8) __attribute__((
    __import_module__("wasix_64v1"),
...
__wasi_bus_error_t __wasi_bus_invoke(
    ...
    int32_t ret = __imported_wasix_64v1_bus_invoke((int32_t) bid, (int64_t) parent, (int32_t) keep_alive, (intptr_t) topic, (intptr_t) topic_len, (int32_t) format, (intptr_t) buf, (intptr_t) buf_len, (intptr_t) retptr0);
    return (uint32_t) ret;
}

int32_t __imported_wasix_64v1_bus_fault(int32_t arg0, int32_t arg1) __attribute__((
    __import_module__("wasix_64v1"),
...
__wasi_bus_error_t __wasi_bus_fault(
    ...
    int32_t ret = __imported_wasix_64v1_bus_fault((int32_t) cid, (int32_t) fault);
    return (uint32_t) ret;
}

int32_t __imported_wasix_64v1_bus_drop(int32_t arg0) __attribute__((
    __import_module__("wasix_64v1"),
...
__wasi_bus_error_t __wasi_bus_drop(
    ...
    int32_t ret = __imported_wasix_64v1_bus_drop((int32_t) cid);
    return (uint32_t) ret;
}

int32_t __imported_wasix_64v1_bus_reply(int32_t arg0, int32_t arg1, int64_t arg2, int64_t arg3) __attribute__((
    __import_module__("wasix_64v1"),
...
__wasi_bus_error_t __wasi_bus_reply(
    ...
    int32_t ret = __imported_wasix_64v1_bus_reply((int32_t) cid, (int32_t) format, (intptr_t) buf, (intptr_t) buf_len);
    return (uint32_t) ret;
}

int32_t __imported_wasix_64v1_bus_callback(int32_t arg0, int64_t arg1, int64_t arg2, int32_t arg3, int64_t arg4, int64_t arg5) __attribute__((
    __import_module__("wasix_64v1"),
...
__wasi_bus_error_t __wasi_bus_callback(
    ...
    size_t topic_len = strlen(topic);
    int32_t ret = __imported_wasix_64v1_bus_callback((int32_t) cid, (intptr_t) topic, (intptr_t) topic_len, (int32_t) format, (intptr_t) buf, (intptr_t) buf_len);
    return (uint32_t) ret;
}

int32_t __imported_wasix_64v1_bus_listen(int64_t arg0, int64_t arg1, int64_t arg2) __attribute__((
    __import_module__("wasix_64v1"),
...
__wasi_bus_error_t __wasi_bus_listen(
    ...
    size_t topic_len = strlen(topic);
    int32_t ret = __imported_wasix_64v1_bus_listen((int64_t) parent, (intptr_t) topic, (intptr_t) topic_len);
    return (uint32_t) ret;
}

int32_t __imported_wasix_64v1_bus_poll(int64_t arg0, int64_t arg1, int64_t arg2, int32_t arg3, int64_t arg4) __attribute__((
    __import_module__("wasix_64v1"),
...
__wasi_bus_error_t __wasi_bus_poll(
    ...
    int32_t ret = __imported_wasix_64v1_bus_poll((int64_t) bid, (int64_t) timeout, (int64_t) events, (int32_t) nevents, (intptr_t) retptr0);
    return (uint32_t) ret;
}

int32_t __imported_wasix_64v1_bus_poll_data(int64_t arg0, int64_t arg1, int64_t arg2, int64_t arg3, int64_t arg4, int64_t arg5, int64_t arg6) __attribute__((
    __import_module__("wasix_64v1"),
...
__wasi_bus_error_t __wasi_bus_poll_data(
    ...
    int32_t ret = __imported_wasix_64v1_bus_poll_data((int64_t) bid, (int64_t) timeout, (int64_t) topic, (int64_t) topic_len, (int64_t) buf, (int64_t) buf_len, (intptr_t) retptr0);
    return (uint32_t) ret;
}
