...
__wasi_errno_t __wasi_thread_spawn(
    ...
    int32_t ret = __imported_wasix_32v1_thread_spawn((int64_t) user_data, (int64_t) stack_base, (int32_t) reactor, (intptr_t) retptr0);
    return (uint16_t) ret;
}
...
int32_t __imported_wasix_32v1_proc_fork(int32_t arg0) __attribute__((
    __import_module__("wasix_32v1"),
...
__wasi_errno_t __wasi_proc_fork(
    ...
    int32_t ret = __imported_wasix_32v1_proc_fork((intptr_t) retptr0);
    return (uint16_t) ret;
}
...
int32_t __imported_wasix_32v1_proc_join(int32_t arg0, int32_t arg1) __attribute__((
    __import_module__("wasix_32v1"),
...
__wasi_errno_t __wasi_proc_join(
    ...
    int32_t ret = __imported_wasix_32v1_proc_join((int32_t) pid, (intptr_t) retptr0);
    return (uint16_t) ret;
}
