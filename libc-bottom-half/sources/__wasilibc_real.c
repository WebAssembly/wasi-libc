...
int32_t __imported_wasix_64v1_thread_spawn(int64_t arg0, int64_t arg1, int32_t arg2, int64_t arg3) __attribute__((
    __import_module__("wasix_64v1"),
...
__wasi_errno_t __wasi_thread_spawn(
    ...
    int32_t ret = __imported_wasix_64v1_thread_spawn((int64_t) user_data, (int64_t) stack_base, (int32_t) reactor, (intptr_t) retptr0);
    return (uint16_t) ret;
}
...
int32_t __imported_wasix_64v1_getppid(int32_t arg0, int64_t arg1) __attribute__((
    __import_module__("wasix_64v1"),
...
__wasi_errno_t __wasi_getppid(
    ...
    int32_t ret = __imported_wasix_64v1_getppid((int32_t) pid, (intptr_t) retptr0);
    return (uint16_t) ret;
}
...
int32_t __imported_wasix_64v1_fork(int64_t arg0) __attribute__((
    __import_module__("wasix_64v1"),
    __import_name__("fork")
));

__wasi_errno_t __wasi_fork(
    __wasi_pid_t *retptr0
){
    int32_t ret = __imported_wasix_64v1_fork((intptr_t) retptr0);
    return (uint16_t) ret;
}
