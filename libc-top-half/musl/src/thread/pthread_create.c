...
#endif
{
	 ...
	 *
	 * In WebAssembly, we leave it to wasi{p3}_thread_start instead.
	 */
#endif
}
...
struct start_args
{
	 ...
	 * in this structure is hardcoded in wasi{p3}_thread_start.
	 */
	void *stack;
	void *tls_base;
	void *(*start_func)(void *);
...
#ifdef __wasip3__
/*
 * We want to ensure wasip3_thread_start is linked whenever
...
#ifdef __wasilibc_unmodified_upstream
	unsigned flags = CLONE_VM | CLONE_FS | CLONE_FILES | CLONE_SIGHAND | CLONE_THREAD | CLONE_SYSVSEM | CLONE_SETTLS | CLONE_PARENT_SETTID | CLONE_CHILD_CLEARTID | CLONE_DETACHED;
#endif
...
#else
#ifdef __wasip3__
	ret = wasip3_thread_new_indirect(wasip3_thread_start, (void *)args);
#else
...
#ifdef __wasip3__
	wasip3_thread_yield_to(new->tid);
#endif
