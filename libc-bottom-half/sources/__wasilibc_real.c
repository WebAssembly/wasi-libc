...
uint32_t __imported_wasi_snapshot_preview1_args_get(uintptr_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
...
uint32_t __imported_wasi_snapshot_preview1_args_sizes_get(uintptr_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_environ_get(uintptr_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_environ_sizes_get(uintptr_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_clock_res_get(uint32_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_clock_time_get(uint32_t, uint64_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_advise(uint32_t, uint64_t, uint64_t, uint32_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_allocate(uint32_t, uint64_t, uint64_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_close(uint32_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_datasync(uint32_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_fdstat_get(uint32_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_fdstat_set_flags(uint32_t, uint32_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_fdstat_set_rights(uint32_t, uint64_t, uint64_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_filestat_get(uint32_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_filestat_set_size(uint32_t, uint64_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_filestat_set_times(uint32_t, uint64_t, uint64_t, uint32_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_pread(uint32_t, uintptr_t, __wasi_size_t, uint64_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_prestat_get(uint32_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_prestat_dir_name(uint32_t, uintptr_t, __wasi_size_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_pwrite(uint32_t, uintptr_t, __wasi_size_t, uint64_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_read(uint32_t, uintptr_t, __wasi_size_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_readdir(uint32_t, uintptr_t, __wasi_size_t, uint64_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_renumber(uint32_t, uint32_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_seek(uint32_t, uint64_t, uint32_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_sync(uint32_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_tell(uint32_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_fd_write(uint32_t, uintptr_t, __wasi_size_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_path_create_directory(uint32_t, uintptr_t, __wasi_size_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_path_filestat_get(uint32_t, uint32_t, uintptr_t, __wasi_size_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_path_filestat_set_times(uint32_t, uint32_t, uintptr_t, __wasi_size_t, uint64_t, uint64_t, uint32_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_path_link(uint32_t, uint32_t, uintptr_t, __wasi_size_t, uint32_t, uintptr_t, __wasi_size_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_path_open(uint32_t, uint32_t, uintptr_t, __wasi_size_t, uint32_t, uint64_t, uint64_t, uint32_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_path_readlink(uint32_t, uintptr_t, __wasi_size_t, uintptr_t, __wasi_size_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_path_remove_directory(uint32_t, uintptr_t, __wasi_size_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_path_rename(uint32_t, uintptr_t, __wasi_size_t, uint32_t, uintptr_t, __wasi_size_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_path_symlink(uintptr_t, __wasi_size_t, uint32_t, uintptr_t, __wasi_size_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_path_unlink_file(uint32_t, uintptr_t, __wasi_size_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_poll_oneoff(uintptr_t, uintptr_t, uint32_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
_Noreturn void __imported_wasi_snapshot_preview1_proc_exit(uint32_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_sched_yield() __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_random_get(uintptr_t, __wasi_size_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_sock_accept(uint32_t, uint32_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_sock_recv(uint32_t, uintptr_t, __wasi_size_t, uint32_t, uintptr_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_sock_send(uint32_t, uintptr_t, __wasi_size_t, uint32_t, uintptr_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
...
uint32_t __imported_wasi_snapshot_preview1_sock_shutdown(uint32_t, uint32_t) __WASI_NOEXCEPT __attribute__((
    __import_module__("wasi_snapshot_preview1"),
