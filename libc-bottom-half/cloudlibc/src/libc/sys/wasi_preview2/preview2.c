...
void environment_tuple2_string_string_free(environment_tuple2_string_string_t *ptr) {
  imports_string_free(&ptr->f0);
  imports_string_free(&ptr->f1);
}

void environment_list_tuple2_string_string_free(environment_list_tuple2_string_string_t *ptr) {
  for (size_t i = 0; i < ptr->len; i++) {
    environment_tuple2_string_string_free(&ptr->ptr[i]);
  }
  if (ptr->len > 0) {
    free(ptr->ptr);
  }
...
void environment_list_string_free(environment_list_string_t *ptr) {
  for (size_t i = 0; i < ptr->len; i++) {
...
void environment_option_string_free(environment_option_string_t *ptr) {
  if (ptr->is_some) {
...
void io_error_error_drop_borrow(io_error_own_error_t handle) {
  __wasm_import_io_error_error_drop(handle.__handle);
}
...
void poll_pollable_drop_borrow(poll_own_pollable_t handle) {
  __wasm_import_poll_pollable_drop(handle.__handle);
}
...
void streams_input_stream_drop_borrow(streams_own_input_stream_t handle) {
  __wasm_import_streams_input_stream_drop(handle.__handle);
}
...
void streams_output_stream_drop_borrow(streams_own_output_stream_t handle) {
  __wasm_import_streams_output_stream_drop(handle.__handle);
}
...
void streams_result_list_u8_stream_error_free(streams_result_list_u8_stream_error_t *ptr) {
  if (!ptr->is_err) {
    streams_list_u8_free(&ptr->val.ok);
  } else {
...
void filesystem_descriptor_drop_borrow(filesystem_own_descriptor_t handle) {
  __wasm_import_filesystem_descriptor_drop(handle.__handle);
}
...
void filesystem_directory_entry_stream_drop_borrow(filesystem_own_directory_entry_stream_t handle) {
  __wasm_import_filesystem_directory_entry_stream_drop(handle.__handle);
}
...
void filesystem_list_u8_free(filesystem_list_u8_t *ptr) {
  for (size_t i = 0; i < ptr->len; i++) {
  }
  if (ptr->len > 0) {
    free(ptr->ptr);
...
void filesystem_tuple2_list_u8_bool_free(filesystem_tuple2_list_u8_bool_t *ptr) {
  filesystem_list_u8_free(&ptr->f0);
}

void filesystem_result_tuple2_list_u8_bool_error_code_free(filesystem_result_tuple2_list_u8_bool_error_code_t *ptr) {
  if (!ptr->is_err) {
    filesystem_tuple2_list_u8_bool_free(&ptr->val.ok);
  } else {
  }
}
...
void network_network_drop_borrow(network_own_network_t handle) {
  __wasm_import_network_network_drop(handle.__handle);
}
...
void udp_list_u8_free(udp_list_u8_t *ptr) {
  for (size_t i = 0; i < ptr->len; i++) {
  }
  if (ptr->len > 0) {
    free(ptr->ptr);
...
void udp_udp_socket_drop_borrow(udp_own_udp_socket_t handle) {
  __wasm_import_udp_udp_socket_drop(handle.__handle);
}
...
void udp_incoming_datagram_stream_drop_borrow(udp_own_incoming_datagram_stream_t handle) {
  __wasm_import_udp_incoming_datagram_stream_drop(handle.__handle);
}
...
void udp_outgoing_datagram_stream_drop_borrow(udp_own_outgoing_datagram_stream_t handle) {
  __wasm_import_udp_outgoing_datagram_stream_drop(handle.__handle);
}
...
void tcp_tcp_socket_drop_borrow(tcp_own_tcp_socket_t handle) {
  __wasm_import_tcp_tcp_socket_drop(handle.__handle);
}
...
void ip_name_lookup_resolve_address_stream_drop_borrow(ip_name_lookup_own_resolve_address_stream_t handle) {
  __wasm_import_ip_name_lookup_resolve_address_stream_drop(handle.__handle);
}
...
void imports_string_set(imports_string_t *ret, char*s) {
  ret->ptr = (uint8_t*) s;
  ret->len = strlen(s);
}
...
void environment_get_environment(environment_list_tuple2_string_string_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  int32_t ptr = (int32_t) &ret_area;
  __wasm_import_environment_get_environment(ptr);
  *ret = (environment_list_tuple2_string_string_t) { (environment_tuple2_string_string_t*)(*((int32_t*) (ptr + 0))), (size_t)(*((int32_t*) (ptr + 4))) };
}

void environment_get_arguments(environment_list_string_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  int32_t ptr = (int32_t) &ret_area;
  __wasm_import_environment_get_arguments(ptr);
  *ret = (environment_list_string_t) { (imports_string_t*)(*((int32_t*) (ptr + 0))), (size_t)(*((int32_t*) (ptr + 4))) };
}

bool environment_initial_cwd(imports_string_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  int32_t ptr = (int32_t) &ret_area;
  __wasm_import_environment_initial_cwd(ptr);
  environment_option_string_t option;
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    ...
    case 1: {
      option.is_some = true;
      option.val = (imports_string_t) { (uint8_t*)(*((int32_t*) (ptr + 4))), (size_t)(*((int32_t*) (ptr + 8))) };
      break;
    }
  }
  *ret = option.val;
...
void io_error_method_error_to_debug_string(io_error_borrow_error_t self, imports_string_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  int32_t ptr = (int32_t) &ret_area;
  __wasm_import_io_error_method_error_to_debug_string((self).__handle, ptr);
  *ret = (imports_string_t) { (uint8_t*)(*((int32_t*) (ptr + 0))), (size_t)(*((int32_t*) (ptr + 4))) };
}
...
void poll_poll(poll_list_borrow_pollable_t *in, poll_list_u32_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  int32_t ptr = (int32_t) &ret_area;
  __wasm_import_poll_poll((int32_t) (*in).ptr, (int32_t) (*in).len, ptr);
  *ret = (poll_list_u32_t) { (uint32_t*)(*((int32_t*) (ptr + 0))), (size_t)(*((int32_t*) (ptr + 4))) };
}

bool streams_method_input_stream_read(streams_borrow_input_stream_t self, uint64_t len, streams_list_u8_t *ret, streams_stream_error_t *err) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  int32_t ptr = (int32_t) &ret_area;
  ...
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    case 0: {
      result.is_err = false;
      result.val.ok = (streams_list_u8_t) { (uint8_t*)(*((int32_t*) (ptr + 4))), (size_t)(*((int32_t*) (ptr + 8))) };
      break;
    }
    case 1: {
      result.is_err = true;
...
bool streams_method_input_stream_blocking_read(streams_borrow_input_stream_t self, uint64_t len, streams_list_u8_t *ret, streams_stream_error_t *err) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  int32_t ptr = (int32_t) &ret_area;
...
bool streams_method_output_stream_write(streams_borrow_output_stream_t self, streams_list_u8_t *contents, streams_stream_error_t *err) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  int32_t ptr = (int32_t) &ret_area;
...
bool streams_method_output_stream_blocking_write_and_flush(streams_borrow_output_stream_t self, streams_list_u8_t *contents, streams_stream_error_t *err) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  int32_t ptr = (int32_t) &ret_area;
...
bool filesystem_method_descriptor_read(filesystem_borrow_descriptor_t self, filesystem_filesize_t length, filesystem_filesize_t offset, filesystem_tuple2_list_u8_bool_t *ret, filesystem_error_code_t *err) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[16];
  int32_t ptr = (int32_t) &ret_area;
  ...
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    case 0: {
      result.is_err = false;
      result.val.ok = (filesystem_tuple2_list_u8_bool_t) {
        (filesystem_list_u8_t) { (uint8_t*)(*((int32_t*) (ptr + 4))), (size_t)(*((int32_t*) (ptr + 8))) },
...
bool filesystem_method_descriptor_write(filesystem_borrow_descriptor_t self, filesystem_list_u8_t *buffer, filesystem_filesize_t offset, filesystem_filesize_t *ret, filesystem_error_code_t *err) {
  __attribute__((__aligned__(8)))
  uint8_t ret_area[16];
  int32_t ptr = (int32_t) &ret_area;
...
bool filesystem_method_descriptor_create_directory_at(filesystem_borrow_descriptor_t self, imports_string_t *path, filesystem_error_code_t *err) {
  __attribute__((__aligned__(1)))
  uint8_t ret_area[2];
  int32_t ptr = (int32_t) &ret_area;
...
bool filesystem_method_descriptor_stat_at(filesystem_borrow_descriptor_t self, filesystem_path_flags_t path_flags, imports_string_t *path, filesystem_descriptor_stat_t *ret, filesystem_error_code_t *err) {
  __attribute__((__aligned__(8)))
  uint8_t ret_area[104];
  int32_t ptr = (int32_t) &ret_area;
...
bool filesystem_method_descriptor_set_times_at(filesystem_borrow_descriptor_t self, filesystem_path_flags_t path_flags, imports_string_t *path, filesystem_new_timestamp_t *data_access_timestamp, filesystem_new_timestamp_t *data_modification_timestamp, filesystem_error_code_t *err) {
  __attribute__((__aligned__(1)))
  uint8_t ret_area[2];
  int32_t variant;
  int64_t variant2;
...
bool filesystem_method_descriptor_link_at(filesystem_borrow_descriptor_t self, filesystem_path_flags_t old_path_flags, imports_string_t *old_path, filesystem_borrow_descriptor_t new_descriptor, imports_string_t *new_path, filesystem_error_code_t *err) {
  __attribute__((__aligned__(1)))
  uint8_t ret_area[2];
  int32_t ptr = (int32_t) &ret_area;
...
bool filesystem_method_descriptor_open_at(filesystem_borrow_descriptor_t self, filesystem_path_flags_t path_flags, imports_string_t *path, filesystem_open_flags_t open_flags, filesystem_descriptor_flags_t flags, filesystem_own_descriptor_t *ret, filesystem_error_code_t *err) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  int32_t ptr = (int32_t) &ret_area;
...
bool filesystem_method_descriptor_readlink_at(filesystem_borrow_descriptor_t self, imports_string_t *path, imports_string_t *ret, filesystem_error_code_t *err) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[12];
  int32_t ptr = (int32_t) &ret_area;
  ...
  switch ((int32_t) (*((uint8_t*) (ptr + 0)))) {
    case 0: {
      result.is_err = false;
      result.val.ok = (imports_string_t) { (uint8_t*)(*((int32_t*) (ptr + 4))), (size_t)(*((int32_t*) (ptr + 8))) };
      break;
    }
    case 1: {
      result.is_err = true;
...
bool filesystem_method_descriptor_remove_directory_at(filesystem_borrow_descriptor_t self, imports_string_t *path, filesystem_error_code_t *err) {
  __attribute__((__aligned__(1)))
  uint8_t ret_area[2];
  int32_t ptr = (int32_t) &ret_area;
...
bool filesystem_method_descriptor_rename_at(filesystem_borrow_descriptor_t self, imports_string_t *old_path, filesystem_borrow_descriptor_t new_descriptor, imports_string_t *new_path, filesystem_error_code_t *err) {
  __attribute__((__aligned__(1)))
  uint8_t ret_area[2];
  int32_t ptr = (int32_t) &ret_area;
...
bool filesystem_method_descriptor_symlink_at(filesystem_borrow_descriptor_t self, imports_string_t *old_path, imports_string_t *new_path, filesystem_error_code_t *err) {
  __attribute__((__aligned__(1)))
  uint8_t ret_area[2];
  int32_t ptr = (int32_t) &ret_area;
...
bool filesystem_method_descriptor_unlink_file_at(filesystem_borrow_descriptor_t self, imports_string_t *path, filesystem_error_code_t *err) {
  __attribute__((__aligned__(1)))
  uint8_t ret_area[2];
  int32_t ptr = (int32_t) &ret_area;
...
bool filesystem_method_descriptor_metadata_hash_at(filesystem_borrow_descriptor_t self, filesystem_path_flags_t path_flags, imports_string_t *path, filesystem_metadata_hash_value_t *ret, filesystem_error_code_t *err) {
  __attribute__((__aligned__(8)))
  uint8_t ret_area[24];
  int32_t ptr = (int32_t) &ret_area;
      ...
      switch ((int32_t) (*((uint8_t*) (ptr + 4)))) {
        ...
        case 1: {
          ...
          option.val = (filesystem_directory_entry_t) {
            (int32_t) (*((uint8_t*) (ptr + 8))),
            (imports_string_t) { (uint8_t*)(*((int32_t*) (ptr + 12))), (size_t)(*((int32_t*) (ptr + 16))) },
          };
          break;
        }
      }
...
bool ip_name_lookup_resolve_addresses(ip_name_lookup_borrow_network_t network, imports_string_t *name, ip_name_lookup_own_resolve_address_stream_t *ret, ip_name_lookup_error_code_t *err) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  int32_t ptr = (int32_t) &ret_area;
...
void random_insecure_get_insecure_random_bytes(uint64_t len, random_list_u8_t *ret) {
  __attribute__((__aligned__(4)))
  uint8_t ret_area[8];
  int32_t ptr = (int32_t) &ret_area;
...
void random_insecure_seed_insecure_seed(random_insecure_seed_tuple2_u64_u64_t *ret) {
  __attribute__((__aligned__(8)))
  uint8_t ret_area[16];
  int32_t ptr = (int32_t) &ret_area;
  __wasm_import_random_insecure_seed_insecure_seed(ptr);
  *ret = (random_insecure_seed_tuple2_u64_u64_t) {
    (uint64_t) (*((int64_t*) (ptr + 0))),
    (uint64_t) (*((int64_t*) (ptr + 8))),
  };
}
